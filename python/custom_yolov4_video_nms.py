...
file_video_stream = cv2.VideoCapture('/home/seiya/yoloboard/glinder_data/test_videos/1.mov')

if (file_video_stream.isOpened()==False):
    print("Unable to read camera feed")

img_width = int(file_video_stream.get(3))
img_height = int(file_video_stream.get(4))

out = cv2.VideoWriter('test_result_25fps_30%thre.avi',cv2.VideoWriter_fourcc(*'MJPG'),25,(img_width,img_height))
...
while True:
    ...
    if ret == True:
        ...
        yolo_model = cv2.dnn.readNetFromDarknet('/home/seiya/yoloboard/cfg/yolov4-custom.cfg','/home/seiya/yoloboard/can_data3/backup/yolov4-custom_best.weights')
